...
[![PHILOSOPHY](https://readme-typing-svg.demolab.com?font=Calibri&size=22&duration=2000&pause=1000&multiline=true&width=750&height=60&lines=💡+Every+deliberate+adjustment+reveals+new+capability)](https://github.com/creativepuru)

</p>

<p align="center">
 <a href="mailto:0941813057estifanos@gmail.com"><img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white"/></a>
 <a href="https://linkedin.com/in/Addisu Amare/" target="_blank"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white"/></a>
 <a href="https://kaggle.com/Addisu Amare" target="_blank"><img src="https://img.shields.io/badge/Kaggle-20BEFF?style=for-the-badge&logo=kaggle&logoColor=white"/></a>
</p>
...
-"To me, tuning a model is like exploration; every parameter change opens up a new frontier."
...
- 🧠 **Expertise**: ML · DL · NLP · CV .LLM 
- ⚙️ **Project**: AI Agents 
- 🤝 **Collab**: Real-time AI Apps & Research 
- 📬 **Reach Me**: 0941813057estifanos@gmail.com 
...
<p align="center">
 <img src="https://github-readme-stats.vercel.app/api?username=Addisu-Amare&show_icons=true&theme=react&locale=en" alt="GitHub Stats" />
</p>

<p align="center">
 <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Addisu-Amare&layout=compact&theme=react" alt="Top Languages" />
</p>
...
|---------|-------------|--------------|--------|
| **[Auto Differentiation using JAX](https://github.com/Addisu-Amare/website_/blob/main/projects/Auto_differentiation_using_Jax.ipynb)** | Automatic differentiation and gradient computation | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/Auto_differentiation_using_Jax.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
| **[Clustering Algorithms](https://github.com/Addisu-Amare/website_/blob/main/projects/Clustering.ipynb)** | K-means, DBSCAN, hierarchical clustering | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/Clustering.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
| **[Random Forest](https://github.com/Addisu-Amare/website_/blob/main/projects/Random_forest.ipynb)** | Ensemble learning with decision trees | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/Random_forest.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
| **[Regularization Techniques](https://github.com/Addisu-Amare/website_/blob/main/projects/Regularization.ipynb)** | L1, L2, dropout, early stopping | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/Regularization.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
| **[Bayesian Linear Regression](https://github.com/Addisu-Amare/website_/blob/main/projects/bayesian_linear_regression.ipynb)** | Probabilistic linear regression | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/bayesian_linear_regression.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
| **[Backpropagation](https://github.com/Addisu-Amare/website_/blob/main/projects/backpropagation.ipynb)** | Neural network training algorithm | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/backpropagation.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
...
## 🧠 Advanced AI & NLP Notebooks
| Project | Description | Last Updated | Status |
|---------|-------------|--------------|--------|
| **[Attention Mechanism Notebook](https://github.com/Addisu-Amare/website_/blob/main/projects/Attention_mechanism.ipynb)** | Attention in deep learning | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/Attention_mechanism.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
| **[Large Language Models](https://github.com/Addisu-Amare/website_/blob/main/projects/LLM.ipynb)** | Transformer-based language models | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/LLM.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
| **[CLIP Implementation](https://github.com/Addisu-Amare/website_/blob/main/projects/CLIP_simple_implementation.ipynb)** | Vision-language pretraining | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/CLIP_simple_implementation.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |

## 🔬 Specialized Architectures Notebooks
| Project | Description | Last Updated | Status |
|---------|-------------|--------------|--------|
| **[GANs Implementation](https://github.com/Addisu-Amare/website_/blob/main/projects/GANs1.ipynb)** | Generative Adversarial Networks | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/GANs1.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
...
| **[Metrics & AUROC](https://github.com/Addisu-Amare/website_/blob/main/projects/metrics-auroc.ipynb)** | Model evaluation and ROC analysis | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/metrics-auroc.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
| **[Efficient Model Training](https://github.com/Addisu-Amare/website_/blob/main/projects/Efficient_model_training.ipynb)** | Optimization techniques | ![Updated](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/repos/Addisu-Amare/website_/commits?path=projects/Efficient_model_training.ipynb&per_page=1&query=$[0].commit.author.date&label=Updated&color=blue&logo=clockify&style=flat-square) | ![Active](https://img.shields.io/badge/Status-Active-success) |
